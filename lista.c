...
Post-condiciones:
	...
	la función actualiza el valor de "*retorno".
*/
void borrar_nodo(lista_t* lista, nodo_t* nodo_a_borrar, nodo_t** nodo_a_rellenar,
...
*/
int buscar_y_borrar(lista_t* lista, size_t tope, void* contexto,
...
int lista_desencolar(lista_t* cola){
	...
	return lista_borrar_de_posicion(cola, 0);
}

/*** Pre y post condiciones en lista.h ***/
void* lista_primero(lista_t* cola){

	return lista_elemento_en_posicion(cola, 0);
}
